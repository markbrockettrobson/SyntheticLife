...
public class EnergySourceTests
{
    ...
    {
        // Arrange
        var energySource = new EnergySource(Location, 100);
        // Act
        var energy = energySource.Energy;
        // Assert
        Assert.That(energy, Is.EqualTo(100));
    }
    ...
    {
        // Arrange
        var energySource = new EnergySource(Location, 1310);
        // Act
        energySource.Energy -= 100;
        // Assert
        Assert.That(energySource.Energy, Is.EqualTo(1210));
    }
}
